                ...
                if ( get_theme_mod('slider_image_1', get_template_directory_uri() . '/images/1.png') ) {
                    ...
                    ?>
                        <div class="slide-inner">
                            <div class="contain animated fadeInDown text-slider">
...
function sydney_slider_button() {
    ...
    if ($slider_button) {
        echo '<a href="' . esc_url($slider_button_url) . '" class="roll-button button-slider down-arrow">' . esc_html($slider_button) . '</a>';
    }
}
